...
export default function Footer() {
  return (
    <footer className="border-t border-white/[0.06] bg-[#0a0f1e]">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          {/* Brand */}
          <div className="text-center md:text-left">
            <p className="text-lg font-bold gradient-text mb-1">Swapnil Nanavati</p>
            <p className="text-xs text-[#8892b0]">Full-Stack Developer &amp; Senior Consultant</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            {SOCIALS.map((social) => (
              <a
                ...
                className="text-[#8892b0] hover:text-[#00d4ff] transition-colors"
              >
                {social.icon}
              </a>
            ))}
